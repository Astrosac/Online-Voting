...
<body>
    <div class="registerform">
        ...
        <form action="" method="POST" >
            ...
            <input type="text" name="VoterID" required placeholder="VoterID"><br>
...
if($Password==$RePassword){
   ...
   $insert="insert into register(FullName,MobileNo,Email,DOB,Password,VoterID,Status,Voted) values('$FullName','$MobileNo','$Email','$DOB','$Password','$VoterID','OFF','NO')";
